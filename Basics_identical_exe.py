...
fix_exe_time = 4.0  # unit is milli second and in real scenario we know that fix_exe_time is at near 170ms for 60B payload and 2 time slot
...
# ------------ make periods ------------------------------------
def select_period(utilization_value, No_tasks, time_slot, expected_util, dist_of_real_util):  # input parameter is overall utilization
...
def total_hyper_period(period_list):
    ...
    for i in range(len(period_list)):
        ...
        exe_time = fix_exe_time * time_slot
        calculated_util += float(exe_time/period_list[i])
